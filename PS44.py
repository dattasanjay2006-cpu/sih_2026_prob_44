...
def fetch_client1(subject_node,subdomain_list,year):
     client=Groq(api_key="your_own_api_key") #Replace this with your actual API key here     
...
def fetch_client2(current_depth,subject_node,subdomain_list,tool,year):
     client=Groq(api_key="your_own_api_key") #Replace your actual Groq API key here     
...
app=Flask(__name__)
app.secret_key="aic_portal_secret_key"
@app.route("/")
def home():
